...
#components_over_threshold(data, title="scikit_learn_cosine_components_over_threshold")

graph = create_network(data, similarity_threshold=SIMILARITY_THRESHOLD, name="Travel Survey scikit-learn cosine similarity network")
plot_network(graph)
