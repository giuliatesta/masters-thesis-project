...
components_over_threshold(data, title="numpy_cosine_components_over_threshold")

graph = create_network(data, similarity_threshold=SIMILARITY_THRESHOLD, name="Travel Survey numpy-cosine similarity network")
plot_network(graph)
